...
test('astro config links the worktree guide from the AI & Agents sidebar', async () => {
	...
	assert.match(astroConfig, /label:\s*["']AI & Agents["'][\s\S]*label:\s*["']Git worktree と Codex 運用["']/);
