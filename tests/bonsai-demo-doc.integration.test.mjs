// ABOUTME: Verifies the docs sidebar exposes the Bonsai demo article from the AI & Agents section.
...
test('astro config links the Bonsai demo article from the AI & Agents sidebar', async () => {
	...
	assert.match(astroConfig, /label:\s*["']AI & Agents["'][\s\S]*label:\s*["']Bonsai-demo 1-bit量子化モデル["']/);
